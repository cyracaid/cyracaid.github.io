...
function renderFooter() {
  ...
  $('#site-footer').innerHTML = `
    ...
    <div class="footer-links">
      <a href="mailto:cyracaid[at]gmail.com" class="footer-link"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 4L12 13 2 4"/></svg>cyracaid[at]gmail.com</a>
